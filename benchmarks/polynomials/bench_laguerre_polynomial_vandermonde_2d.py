...
class BenchLaguerrePolynomialVandermonde2D:
    params = [
        [10, 100, 1000, 10000],
    ...
    def time_laguerre_polynomial_vandermonde_2d(self, batch_size, dtype):
        self.func(self.x, self.y, self.degree)

    def peak_memory_laguerre_polynomial_vandermonde_2d(self, batch_size, dtype):
        self.func(self.x, self.y, self.degree)
