...
from beignet.datasets import VeithCytochromeP4502D6InhibitionDataset


class BenchVeithCytochromeP4502D6InhibitionDataset:
    params = [
        [10, 100, 1000],
    ]
    ...
    def setup(self, batch_size):
        self.dataset = VeithCytochromeP4502D6InhibitionDataset(
            root=os.getenv("BEIGNET_BENCHMARKS_DATASET_ROOT", "/tmp")
            + "/veith_cytochrome_p450_2d6_inhibition",
            download=False,
            transform=None,
