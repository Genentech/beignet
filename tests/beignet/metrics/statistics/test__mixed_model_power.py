...
def test_mixed_model_power(
    effect_size, sample_size, cluster_size, intraclass_correlation, alpha, dtype
):
    ...
    metric.update(effect_size_tensor, sample_size_tensor, cluster_size_tensor, icc_tensor)
