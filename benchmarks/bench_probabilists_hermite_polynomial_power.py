...
class ProbabilistsHermitePolynomialPowerBenchmark:
    params = [
        [10, 100, 1000, 10000],
    ...
    def time_probabilists_hermite_polynomial_power(self, batch_size, dtype):
        self.func(self.input, self.exponent, self.maximum_exponent)

    def peak_memory_probabilists_hermite_polynomial_power(self, batch_size, dtype):
        self.func(self.input, self.exponent, self.maximum_exponent)
