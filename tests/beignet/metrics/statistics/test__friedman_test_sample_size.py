...
from beignet.metrics.statistics import FriedmanTestSampleSize
...
def test_friedman_test_sample_size(
    effect_size, groups, power, alpha, dtype
):
    metric = FriedmanTestSampleSize(power=power, alpha=alpha)
