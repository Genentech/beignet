...
def test_jonckheere_terpstra_test_power(
    ...
    # Create sample sizes for each group (equal sizes)
    sample_sizes_tensor = torch.tensor([30] * groups, dtype=dtype)

    metric.update(effect_size_tensor, sample_sizes_tensor)
