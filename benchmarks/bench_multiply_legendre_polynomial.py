...
class MultiplyLegendrePolynomialBenchmark:
    params = [
        [10, 100, 1000, 10000],
    ...
    def time_multiply_legendre_polynomial(self, batch_size, dtype):
        self.func(self.input, self.other, self.mode)

    def peak_memory_multiply_legendre_polynomial(self, batch_size, dtype):
        self.func(self.input, self.other, self.mode)
