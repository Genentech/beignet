...
class AnalysisOfVarianceSampleSize(Metric):
    """TorchMetrics wrapper for Analysis of Variance sample size calculation.
    ...
    **kwargs
    ...
    Examples
    --------
    >>> metric = AnalysisOfVarianceSampleSize(power=0.8, alpha=0.05)
    ...
    def plot(
        ...
        **kwargs: Any,
        ...
        """Plot Analysis of Variance sample size curves varying different parameters.
        ...
        **kwargs : dict
        ...
        Examples
        --------
        >>> metric = AnalysisOfVarianceSampleSize()
        ...
        for param_val in param_values:
            ...
            for x_val in x_values:
                if dep_var == "effect_size":
                    sample_size_val = beignet.analysis_of_variance_sample_size(
        ...
        if title is None:
            title = "Sample Size Analysis: One-Way Analysis of Variance"
        ax.set_title(title)
