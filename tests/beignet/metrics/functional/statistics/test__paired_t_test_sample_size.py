...
def test_paired_t_test_sample_size(batch_size, dtype):
    """Test paired_t_test_sample_size functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.paired_t_test_sample_size(test_input)
        )
        result_direct = beignet.statistics.paired_t_test_sample_size(test_input)
        ...
        assert hasattr(beignet.statistics, "paired_t_test_sample_size")
        assert callable(beignet.metrics.functional.statistics.paired_t_test_sample_size)
        assert callable(beignet.statistics.paired_t_test_sample_size)
