...
def test_two_one_sided_tests_one_sample_t_power(batch_size, dtype):
    """Test two_one_sided_tests_one_sample_t_power functional wrapper."""
    ...
    try:
        result_functional = beignet.metrics.functional.statistics.two_one_sided_tests_one_sample_t_power(
            test_input,
        )
        result_direct = beignet.statistics.two_one_sided_tests_one_sample_t_power(
            test_input,
        )
        ...
        assert hasattr(beignet.statistics, "two_one_sided_tests_one_sample_t_power")
        assert callable(
            beignet.metrics.functional.statistics.two_one_sided_tests_one_sample_t_power,
        )
        assert callable(beignet.statistics.two_one_sided_tests_one_sample_t_power)
