...
def test_analysis_of_covariance_minimum_detectable_effect(batch_size, dtype):
    """Test analysis_of_covariance_minimum_detectable_effect functional wrapper."""
    ...
    try:
        result_functional = beignet.metrics.functional.statistics.analysis_of_covariance_minimum_detectable_effect(
            test_input,
        )
        result_direct = (
            beignet.statistics.analysis_of_covariance_minimum_detectable_effect(
                test_input,
            )
        )
        ...
        assert callable(
            beignet.metrics.functional.statistics.analysis_of_covariance_minimum_detectable_effect,
        )
        assert callable(
            beignet.statistics.analysis_of_covariance_minimum_detectable_effect,
        )
