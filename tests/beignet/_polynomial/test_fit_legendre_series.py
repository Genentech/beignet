...
def test_fit_legendre_series():
    ...
    numpy.testing.assert_raises(
        TypeError, beignet.polynomial._legfit.fit_legendre_series, [1], [1], 0, w=[[1]]
    )
    numpy.testing.assert_raises(
        TypeError, beignet.polynomial._legfit.fit_legendre_series, [1], [1], 0, w=[1, 1]
    )
    numpy.testing.assert_raises(
        ValueError,
    ...
    numpy.testing.assert_raises(
        ValueError, beignet.polynomial._legfit.fit_legendre_series, [1], [1], [2, -1, 6]
    )
    numpy.testing.assert_raises(
    ...
    wcoef3 = beignet.polynomial._legfit.fit_legendre_series(x, yw, [0, 1, 2, 3], w=w)
    torch.testing.assert_close(wcoef3, coef3)
