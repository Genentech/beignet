...
def test_two_way_analysis_of_variance_sample_size(batch_size, dtype):
    """Test two_way_analysis_of_variance_sample_size functional wrapper."""
    ...
    try:
        result_functional = beignet.metrics.functional.statistics.two_way_analysis_of_variance_sample_size(
            test_input,
        )
        result_direct = beignet.statistics.two_way_analysis_of_variance_sample_size(
            test_input,
        )
        ...
        assert hasattr(beignet.statistics, "two_way_analysis_of_variance_sample_size")
        assert callable(
            beignet.metrics.functional.statistics.two_way_analysis_of_variance_sample_size,
        )
        assert callable(beignet.statistics.two_way_analysis_of_variance_sample_size)
