...
def test_logistic_regression_sample_size(batch_size, dtype):
    """Test logistic_regression_sample_size functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.logistic_regression_sample_size(
                test_input,
            )
        )
        result_direct = beignet.statistics.logistic_regression_sample_size(test_input)
        ...
        assert hasattr(beignet.statistics, "logistic_regression_sample_size")
        assert callable(
            beignet.metrics.functional.statistics.logistic_regression_sample_size,
        )
        assert callable(beignet.statistics.logistic_regression_sample_size)
