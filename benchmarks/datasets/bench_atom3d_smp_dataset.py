...
from beignet.datasets import ATOM3DSMPDataset


class BenchATOM3DSMPDataset:
    params = [
        [10, 100, 1000],
    ]
    ...
    def peak_memory___init__(self, batch_size):
        ATOM3DSMPDataset(
            root=os.getenv("BEIGNET_BENCHMARKS_DATASET_ROOT", ".") + "/atom3d_smp",
            download=True,
            transform=None,
            target_transform=None,
        )
