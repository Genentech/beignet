...
def test_chi_square_independence_minimum_detectable_effect(batch_size, dtype):
    """Test chi_square_independence_minimum_detectable_effect functional wrapper."""
    ...
    try:
        result_functional = beignet.metrics.functional.statistics.chi_square_independence_minimum_detectable_effect(
            test_input,
        )
        result_direct = (
            beignet.statistics.chi_square_independence_minimum_detectable_effect(
                test_input,
            )
        )
        ...
        assert callable(
            beignet.metrics.functional.statistics.chi_square_independence_minimum_detectable_effect,
        )
        assert callable(
            beignet.statistics.chi_square_independence_minimum_detectable_effect,
        )
