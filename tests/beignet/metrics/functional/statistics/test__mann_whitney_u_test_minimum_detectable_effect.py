...
def test_mann_whitney_u_test_minimum_detectable_effect(batch_size, dtype):
    """Test mann_whitney_u_test_minimum_detectable_effect functional wrapper."""
    ...
    try:
        result_functional = beignet.metrics.functional.statistics.mann_whitney_u_test_minimum_detectable_effect(
            test_input,
        )
        result_direct = (
            beignet.statistics.mann_whitney_u_test_minimum_detectable_effect(test_input)
        )
        ...
        assert callable(
            beignet.metrics.functional.statistics.mann_whitney_u_test_minimum_detectable_effect,
        )
        assert callable(
            beignet.statistics.mann_whitney_u_test_minimum_detectable_effect,
        )
