...
def test_mann_whitney_u_test_power(batch_size, dtype):
    """Test mann_whitney_u_test_power functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.mann_whitney_u_test_power(test_input)
        )
        result_direct = beignet.statistics.mann_whitney_u_test_power(test_input)
        ...
        assert hasattr(beignet.statistics, "mann_whitney_u_test_power")
        assert callable(beignet.metrics.functional.statistics.mann_whitney_u_test_power)
        assert callable(beignet.statistics.mann_whitney_u_test_power)
