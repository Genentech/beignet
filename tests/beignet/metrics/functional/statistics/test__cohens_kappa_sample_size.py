...
def test_cohens_kappa_sample_size(batch_size, dtype):
    """Test cohens_kappa_sample_size functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.cohens_kappa_sample_size(test_input)
        )
        result_direct = beignet.statistics.cohens_kappa_sample_size(test_input)
        ...
        assert hasattr(beignet.statistics, "cohens_kappa_sample_size")
        assert callable(beignet.metrics.functional.statistics.cohens_kappa_sample_size)
        assert callable(beignet.statistics.cohens_kappa_sample_size)
