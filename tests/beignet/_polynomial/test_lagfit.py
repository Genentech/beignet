...
def test_lagfit():
    ...
    numpy.testing.assert_almost_equal(beignet.polynomial._lagval.lagval(x, coef3), y)
    ...
    numpy.testing.assert_almost_equal(beignet.polynomial._lagval.lagval(x, coef4), y)
