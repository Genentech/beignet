...
from beignet.datasets import ATOM3DMSPDataset


class BenchATOM3DMSPDataset:
    params = [
        [10, 100, 1000],
    ]
    ...
    def peak_memory___init__(self, batch_size):
        ATOM3DMSPDataset(
            root=os.getenv("BEIGNET_BENCHMARKS_DATASET_ROOT", ".") + "/atom3d_msp",
            download=True,
            transform=None,
            target_transform=None,
        )
