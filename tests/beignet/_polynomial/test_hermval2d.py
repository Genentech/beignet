...
def test_hermval2d():
    ...
    numpy.testing.assert_raises(
        ValueError, beignet.polynomial._hermval2d.hermval2d, x1, x2[:2], c2d
    )

    tgt = y1 * y2
    res = beignet.polynomial._hermval2d.hermval2d(x1, x2, c2d)
    numpy.testing.assert_almost_equal(res, tgt)

    z = numpy.ones((2, 3))
    res = beignet.polynomial._hermval2d.hermval2d(z, z, c2d)
