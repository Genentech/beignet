...
def test_mcnemars_test_power(batch_size, dtype):
    """Test mcnemars_test_power functional wrapper."""
    ...
    try:
        result_functional = beignet.metrics.functional.statistics.mcnemars_test_power(
            test_input,
        )
        result_direct = beignet.statistics.mcnemars_test_power(test_input)
        ...
        assert hasattr(beignet.metrics.functional.statistics, "mcnemars_test_power")
        assert hasattr(beignet.statistics, "mcnemars_test_power")
        assert callable(beignet.metrics.functional.statistics.mcnemars_test_power)
        assert callable(beignet.statistics.mcnemars_test_power)
