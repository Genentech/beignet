...
def test_independent_z_test_power(batch_size, effect_size, sample_size, alpha, dtype):
    """Test independent_z_test_power functional wrapper."""
    ...
    result_functional = beignet.metrics.functional.statistics.independent_z_test_power(
        effect_size_tensor,
        sample_size_tensor,
        alpha=alpha,
    )
    result_direct = beignet.statistics.independent_z_test_power(
        effect_size_tensor,
        sample_size_tensor,
        alpha=alpha,
    )
