...
def test_analysis_of_covariance_power(batch_size, dtype):
    """Test analysis_of_covariance_power functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.analysis_of_covariance_power(
                test_input,
            )
        )
        result_direct = beignet.statistics.analysis_of_covariance_power(test_input)
        ...
        assert hasattr(beignet.statistics, "analysis_of_covariance_power")
        assert callable(
            beignet.metrics.functional.statistics.analysis_of_covariance_power,
        )
        assert callable(beignet.statistics.analysis_of_covariance_power)
