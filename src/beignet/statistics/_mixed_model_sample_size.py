...
def mixed_model_sample_size(
    ...
    *,
    ...
    # Initial approximation accounting for design effect
    sqrt2 = math.sqrt(2.0)
    ...
    # Initial guess for total effective sample size
    n_eff_needed = 4 * ((z_alpha + z_beta) / effect_size) ** 2

    # Convert to number of subjects accounting for design effect
