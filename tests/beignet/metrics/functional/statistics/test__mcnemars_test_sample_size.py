...
def test_mcnemars_test_sample_size(batch_size, dtype):
    """Test mcnemars_test_sample_size functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.mcnemars_test_sample_size(test_input)
        )
        result_direct = beignet.statistics.mcnemars_test_sample_size(test_input)
        ...
        assert hasattr(beignet.statistics, "mcnemars_test_sample_size")
        assert callable(beignet.metrics.functional.statistics.mcnemars_test_sample_size)
        assert callable(beignet.statistics.mcnemars_test_sample_size)
