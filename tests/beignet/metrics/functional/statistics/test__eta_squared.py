...
def test_eta_squared(batch_size, dtype):
    """Test eta_squared functional wrapper."""
    ...
    try:
        ...
        result_direct = beignet.statistics.eta_squared(test_input)
        ...
        assert hasattr(beignet.metrics.functional.statistics, "eta_squared")
        assert hasattr(beignet.statistics, "eta_squared")
        assert callable(beignet.metrics.functional.statistics.eta_squared)
        assert callable(beignet.statistics.eta_squared)
