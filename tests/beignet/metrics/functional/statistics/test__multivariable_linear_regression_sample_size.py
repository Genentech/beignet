...
def test_multivariable_linear_regression_sample_size(batch_size, dtype):
    """Test multivariable_linear_regression_sample_size functional wrapper."""
    ...
    try:
        result_functional = beignet.metrics.functional.statistics.multivariable_linear_regression_sample_size(
            test_input,
        )
        result_direct = beignet.statistics.multivariable_linear_regression_sample_size(
            test_input,
        )
        ...
        assert callable(
            beignet.metrics.functional.statistics.multivariable_linear_regression_sample_size,
        )
        assert callable(beignet.statistics.multivariable_linear_regression_sample_size)
