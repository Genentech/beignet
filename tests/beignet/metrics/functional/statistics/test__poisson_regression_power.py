...
def test_poisson_regression_power(batch_size, dtype):
    """Test poisson_regression_power functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.poisson_regression_power(test_input)
        )
        result_direct = beignet.statistics.poisson_regression_power(test_input)
        ...
        assert hasattr(beignet.statistics, "poisson_regression_power")
        assert callable(beignet.metrics.functional.statistics.poisson_regression_power)
        assert callable(beignet.statistics.poisson_regression_power)
