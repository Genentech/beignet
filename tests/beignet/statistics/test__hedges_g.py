...
def test_hedges_g(batch_size, n1, n2, dtype):
    ...
    result_grad = beignet.hedges_g(group1_grad, group2_grad)
    ...
    compiled_hedges_g = torch.compile(beignet.hedges_g, fullgraph=True)
    ...
    large_cohens_d = beignet.cohens_d(large_group1, large_group2, pooled=True)
    large_hedges_g = beignet.hedges_g(large_group1, large_group2)
    ...
    small_cohens_d = beignet.cohens_d(small_group1, small_group2, pooled=True)
    small_hedges_g = beignet.hedges_g(small_group1, small_group2)
    ...
    result_known = beignet.hedges_g(normal1, normal2)
