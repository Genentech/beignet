...
class EvaluateChebyshevPolynomial2DBenchmark:
    params = [
        [10, 100, 1000, 10000],
    ...
    def time_evaluate_chebyshev_polynomial_2d(self, batch_size, dtype):
        self.func(self.input)

    def peak_memory_evaluate_chebyshev_polynomial_2d(self, batch_size, dtype):
        self.func(self.input)
