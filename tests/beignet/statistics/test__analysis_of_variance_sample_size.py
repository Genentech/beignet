...
def test_analysis_of_variance_sample_size(batch_size, dtype):
    """Test Analysis of Variance sample size calculation."""
    ...
    result = beignet.statistics.analysis_of_variance_sample_size(
        effect_sizes,
        k_values,
        power=0.8,
        alpha=0.05,
    ...
    result_out = beignet.statistics.analysis_of_variance_sample_size(
        effect_sizes,
        k_values,
        power=0.8,
        alpha=0.05,
    ...
    small_effect = beignet.statistics.analysis_of_variance_sample_size(
        torch.tensor(0.1, dtype=dtype),
        torch.tensor(3.0, dtype=dtype),
        power=0.8,
    )
    large_effect = beignet.statistics.analysis_of_variance_sample_size(
    ...
    low_power = beignet.statistics.analysis_of_variance_sample_size(
        torch.tensor(0.25, dtype=dtype),
        torch.tensor(3.0, dtype=dtype),
        power=0.5,
    )
    high_power = beignet.statistics.analysis_of_variance_sample_size(
        torch.tensor(0.25, dtype=dtype),
        torch.tensor(3.0, dtype=dtype),
        power=0.9,
    )
    ...
    few_groups = beignet.statistics.analysis_of_variance_sample_size(
        torch.tensor(0.25, dtype=dtype),
        torch.tensor(3.0, dtype=dtype),
        power=0.8,
    )
    many_groups = beignet.statistics.analysis_of_variance_sample_size(
        torch.tensor(0.25, dtype=dtype),
    ...
    result_grad = beignet.statistics.analysis_of_variance_sample_size(
        effect_grad,
        k_grad,
        power=0.8,
    )
    ...
    # Test Analysis of Variance sample size against known theoretical values
    ...
    n = beignet.statistics.analysis_of_variance_sample_size(
        effect_size,
        k,
        power=0.8,
        alpha=0.05,
    ...
    n_large = beignet.statistics.analysis_of_variance_sample_size(
        large_effect_known,
        k,
        power=0.8,
        alpha=0.05,
    ...
    n_consistency = beignet.statistics.analysis_of_variance_sample_size(
    ...
    actual_power = beignet.statistics.analysis_of_variance_power(
        effect_size_consistency,
        n_consistency,
        k_consistency,
        alpha=alpha,
    ...
    # Test Analysis of Variance sample size against statsmodels reference implementation (only for float64)
    if dtype == torch.float64:
        ...
        for f_val, k_val, power_val, alpha_val in test_cases:
            ...
            beignet_result = beignet.statistics.analysis_of_variance_sample_size(
                effect_size_statsmodels,
                k_statsmodels,
                power=power_val,
                alpha=alpha_val,
            )
    ...
    tiny_effect = beignet.statistics.analysis_of_variance_sample_size(
    ...
    large_effect_edge = beignet.statistics.analysis_of_variance_sample_size(
    ...
    high_power_edge = beignet.statistics.analysis_of_variance_sample_size(
        torch.tensor(0.25, dtype=dtype),
        torch.tensor(3.0, dtype=dtype),
        power=0.99,
    )
    normal_power_edge = beignet.statistics.analysis_of_variance_sample_size(
        torch.tensor(0.25, dtype=dtype),
        torch.tensor(3.0, dtype=dtype),
        power=0.8,
    )
    ...
    two_groups = beignet.statistics.analysis_of_variance_sample_size(
    ...
    many_groups_edge = beignet.statistics.analysis_of_variance_sample_size(
        torch.tensor(0.25, dtype=dtype),
    ...
    for power in powers:
        n_power = beignet.statistics.analysis_of_variance_sample_size(
            effect_size_powers,
            k_powers,
            power=power,
        )
