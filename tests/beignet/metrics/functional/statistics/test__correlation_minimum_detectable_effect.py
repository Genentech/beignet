...
def test_correlation_minimum_detectable_effect(batch_size, dtype):
    """Test correlation_minimum_detectable_effect functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.correlation_minimum_detectable_effect(
                test_input,
            )
        )
        result_direct = beignet.statistics.correlation_minimum_detectable_effect(
            test_input,
        )
        ...
        assert hasattr(beignet.statistics, "correlation_minimum_detectable_effect")
        assert callable(
            beignet.metrics.functional.statistics.correlation_minimum_detectable_effect,
        )
        assert callable(beignet.statistics.correlation_minimum_detectable_effect)
