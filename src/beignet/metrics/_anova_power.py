...
class ANOVAPower(Metric):
    """TorchMetrics wrapper for ANOVA power calculation.

    This metric accumulates effect sizes, sample sizes, and number of groups across batches,
    then computes the statistical power for one-way ANOVA F-tests.
    ...
    **kwargs
    ...
    def plot(
        ...
        **kwargs: Any,
        ...
        """Plot ANOVA power curves varying different parameters.
        ...
        **kwargs : dict
        ...
        if title is None:
            title = "Power Analysis: One-Way ANOVA"
        ax.set_title(title)
