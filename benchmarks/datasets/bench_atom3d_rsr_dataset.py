...
from beignet.datasets import ATOM3DRSRDataset


class BenchATOM3DRSRDataset:
    params = [
        [10, 100, 1000],
    ]
    ...
    def peak_memory___init__(self, batch_size):
        ATOM3DRSRDataset(
            root=os.getenv("BEIGNET_BENCHMARKS_DATASET_ROOT", ".") + "/atom3d_rsr",
            download=True,
            transform=None,
            target_transform=None,
        )
