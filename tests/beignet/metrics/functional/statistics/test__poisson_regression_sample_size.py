...
def test_poisson_regression_sample_size(batch_size, dtype):
    """Test poisson_regression_sample_size functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.poisson_regression_sample_size(
                test_input,
            )
        )
        result_direct = beignet.statistics.poisson_regression_sample_size(test_input)
        ...
        assert hasattr(beignet.statistics, "poisson_regression_sample_size")
        assert callable(
            beignet.metrics.functional.statistics.poisson_regression_sample_size,
        )
        assert callable(beignet.statistics.poisson_regression_sample_size)
