...
def test_proportional_hazards_model_sample_size(batch_size, dtype):
    """Test proportional_hazards_model_sample_size functional wrapper."""
    ...
    try:
        result_functional = beignet.metrics.functional.statistics.proportional_hazards_model_sample_size(
            test_input,
        )
        result_direct = beignet.statistics.proportional_hazards_model_sample_size(
            test_input,
        )
        ...
        assert hasattr(beignet.statistics, "proportional_hazards_model_sample_size")
        assert callable(
            beignet.metrics.functional.statistics.proportional_hazards_model_sample_size,
        )
        assert callable(beignet.statistics.proportional_hazards_model_sample_size)
