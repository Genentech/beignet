...
def test_repeated_measures_analysis_of_variance_sample_size(batch_size, dtype):
    """Test repeated_measures_analysis_of_variance_sample_size functional wrapper."""
    ...
    try:
        result_functional = beignet.metrics.functional.statistics.repeated_measures_analysis_of_variance_sample_size(
            test_input,
        )
        result_direct = (
            beignet.statistics.repeated_measures_analysis_of_variance_sample_size(
                test_input,
            )
        )
        ...
        assert callable(
            beignet.metrics.functional.statistics.repeated_measures_analysis_of_variance_sample_size,
        )
        assert callable(
            beignet.statistics.repeated_measures_analysis_of_variance_sample_size,
        )
