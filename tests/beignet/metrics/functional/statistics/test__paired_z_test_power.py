...
def test_paired_z_test_power(batch_size, dtype):
    """Test paired_z_test_power functional wrapper."""
    ...
    try:
        result_functional = beignet.metrics.functional.statistics.paired_z_test_power(
            test_input,
        )
        result_direct = beignet.statistics.paired_z_test_power(test_input)
        ...
        assert hasattr(beignet.metrics.functional.statistics, "paired_z_test_power")
        assert hasattr(beignet.statistics, "paired_z_test_power")
        assert callable(beignet.metrics.functional.statistics.paired_z_test_power)
        assert callable(beignet.statistics.paired_z_test_power)
