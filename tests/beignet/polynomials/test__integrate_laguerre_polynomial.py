...
#
#             for _ in range(j):
#                 target = beignet.polynomials.integrate_laguerre_polynomial(
#                     target,
#                     order=1,
#                 )
#
...
#             axis=0,
#         ),
#         torch.vstack([beignet.polynomials.integrate_laguerre_polynomial(c) for c in c2d.T]).T,
#     )
#
#     torch.testing.assert_close(
#         beignet.polynomials.integrate_laguerre_polynomial(
...
#             axis=1,
#         ),
#         torch.vstack([beignet.polynomials.integrate_laguerre_polynomial(c) for c in c2d]),
#     )
#
#     torch.testing.assert_close(
#         beignet.polynomials.integrate_laguerre_polynomial(
...
#             axis=1,
#         ),
#         torch.vstack([beignet.polynomials.integrate_laguerre_polynomial(c, k=3) for c in c2d]),
#     )
