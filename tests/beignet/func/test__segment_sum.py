...
#     )
#
#     # Allow indexes to be potentially out-of-bounds for testing
#     indexes = draw(
#         st.lists(
#             elements=st.integers(min_value=0, max_value=num_elements * 2 - 1),
...
#     expected_shape = (n if n is not None else (indexes.max().item() + 1), *input.shape[1:])
#
...
from src.beignet.func._molecular_dynamics._partition.__segment_sum import _segment_sum
