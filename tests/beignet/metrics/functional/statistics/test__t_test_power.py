...
def test_t_test_power(batch_size, effect_size, sample_size, alpha, dtype):
    """Test t_test_power functional wrapper."""
    ...
    result_functional = beignet.metrics.functional.statistics.t_test_power(
        effect_size_tensor,
        sample_size_tensor,
        alpha=alpha,
    )
    result_direct = beignet.statistics.t_test_power(
        effect_size_tensor,
        sample_size_tensor,
        alpha=alpha,
    )
