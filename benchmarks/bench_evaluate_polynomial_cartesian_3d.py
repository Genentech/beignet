...
class EvaluatePolynomialCartesian3DBenchmark:
    params = [
        [10, 100, 1000, 10000],
    ...
    def time_evaluate_polynomial_cartesian_3d(self, batch_size, dtype):
        self.func(self.input)

    def peak_memory_evaluate_polynomial_cartesian_3d(self, batch_size, dtype):
        self.func(self.input)
