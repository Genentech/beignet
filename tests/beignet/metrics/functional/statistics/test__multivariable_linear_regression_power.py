...
def test_multivariable_linear_regression_power(batch_size, dtype):
    """Test multivariable_linear_regression_power functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.multivariable_linear_regression_power(
                test_input,
            )
        )
        result_direct = beignet.statistics.multivariable_linear_regression_power(
            test_input,
        )
        ...
        assert hasattr(beignet.statistics, "multivariable_linear_regression_power")
        assert callable(
            beignet.metrics.functional.statistics.multivariable_linear_regression_power,
        )
        assert callable(beignet.statistics.multivariable_linear_regression_power)
