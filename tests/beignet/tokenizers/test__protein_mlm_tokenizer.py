...
from beignet.transforms import ProteinMLMTokenizerTransform
from torch import Size


class TestProteinmMLMTokenizer:
    def test_3Di_tokenizer(self):
        inputs = ["GdPfQaPfIlSvRvLvEcQvClGpId"]

        path = importlib.resources.files("lobster") / "assets" / "3di_tokenizer"

        tokenizer = ProteinMLMTokenizer.from_pretrained(path)
    ...
    def test_cdna_tokenizer(self):
        ...
        transform_fn = ProteinMLMTokenizerTransform(
