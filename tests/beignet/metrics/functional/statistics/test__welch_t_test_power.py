...
def test_welch_t_test_power(batch_size, dtype):
    """Test welch_t_test_power functional wrapper."""
    ...
    try:
        ...
        result_direct = beignet.statistics.welch_t_test_power(test_input)
        ...
        assert hasattr(beignet.metrics.functional.statistics, "welch_t_test_power")
        assert hasattr(beignet.statistics, "welch_t_test_power")
        assert callable(beignet.metrics.functional.statistics.welch_t_test_power)
        assert callable(beignet.statistics.welch_t_test_power)
