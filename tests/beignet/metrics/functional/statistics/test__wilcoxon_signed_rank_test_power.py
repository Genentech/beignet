...
def test_wilcoxon_signed_rank_test_power(batch_size, dtype):
    """Test wilcoxon_signed_rank_test_power functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.wilcoxon_signed_rank_test_power(
                test_input,
            )
        )
        result_direct = beignet.statistics.wilcoxon_signed_rank_test_power(test_input)
        ...
        assert hasattr(beignet.statistics, "wilcoxon_signed_rank_test_power")
        assert callable(
            beignet.metrics.functional.statistics.wilcoxon_signed_rank_test_power,
        )
        assert callable(beignet.statistics.wilcoxon_signed_rank_test_power)
