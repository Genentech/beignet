...
def test_partial_eta_squared(batch_size, dtype):
    """Test partial_eta_squared functional wrapper."""
    ...
    try:
        result_functional = beignet.metrics.functional.statistics.partial_eta_squared(
            test_input,
        )
        result_direct = beignet.statistics.partial_eta_squared(test_input)
        ...
        assert hasattr(beignet.metrics.functional.statistics, "partial_eta_squared")
        assert hasattr(beignet.statistics, "partial_eta_squared")
        assert callable(beignet.metrics.functional.statistics.partial_eta_squared)
        assert callable(beignet.statistics.partial_eta_squared)
