...
def test_two_one_sided_tests_one_sample_t_sample_size(batch_size, dtype):
    """Test two_one_sided_tests_one_sample_t_sample_size functional wrapper."""
    ...
    try:
        result_functional = beignet.metrics.functional.statistics.two_one_sided_tests_one_sample_t_sample_size(
            test_input,
        )
        result_direct = beignet.statistics.two_one_sided_tests_one_sample_t_sample_size(
            test_input,
        )
        ...
        assert callable(
            beignet.metrics.functional.statistics.two_one_sided_tests_one_sample_t_sample_size,
        )
        assert callable(beignet.statistics.two_one_sided_tests_one_sample_t_sample_size)
