...
from beignet.rotations._euler_angle_to_quaternion import euler_angle_to_quaternion
from beignet.rotations._quaternion_to_euler_angle import quaternion_to_euler_angle
