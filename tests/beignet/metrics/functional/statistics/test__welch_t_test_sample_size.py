...
def test_welch_t_test_sample_size(batch_size, dtype):
    """Test welch_t_test_sample_size functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.welch_t_test_sample_size(test_input)
        )
        result_direct = beignet.statistics.welch_t_test_sample_size(test_input)
        ...
        assert hasattr(beignet.statistics, "welch_t_test_sample_size")
        assert callable(beignet.metrics.functional.statistics.welch_t_test_sample_size)
        assert callable(beignet.statistics.welch_t_test_sample_size)
