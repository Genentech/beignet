...
def test_logistic_regression_power(batch_size, dtype):
    """Test logistic_regression_power functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.logistic_regression_power(test_input)
        )
        result_direct = beignet.statistics.logistic_regression_power(test_input)
        ...
        assert hasattr(beignet.statistics, "logistic_regression_power")
        assert callable(beignet.metrics.functional.statistics.logistic_regression_power)
        assert callable(beignet.statistics.logistic_regression_power)
