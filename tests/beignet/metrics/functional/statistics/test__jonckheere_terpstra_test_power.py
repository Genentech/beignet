...
def test_jonckheere_terpstra_test_power(batch_size, dtype):
    """Test jonckheere_terpstra_test_power functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.jonckheere_terpstra_test_power(
                test_input,
            )
        )
        result_direct = beignet.statistics.jonckheere_terpstra_test_power(test_input)
        ...
        assert hasattr(beignet.statistics, "jonckheere_terpstra_test_power")
        assert callable(
            beignet.metrics.functional.statistics.jonckheere_terpstra_test_power,
        )
        assert callable(beignet.statistics.jonckheere_terpstra_test_power)
