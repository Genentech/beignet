...
def test_repeated_measures_analysis_of_variance_power(batch_size, dtype):
    """Test repeated_measures_analysis_of_variance_power functional wrapper."""
    ...
    try:
        result_functional = beignet.metrics.functional.statistics.repeated_measures_analysis_of_variance_power(
            test_input,
        )
        result_direct = beignet.statistics.repeated_measures_analysis_of_variance_power(
            test_input,
        )
        ...
        assert callable(
            beignet.metrics.functional.statistics.repeated_measures_analysis_of_variance_power,
        )
        assert callable(beignet.statistics.repeated_measures_analysis_of_variance_power)
