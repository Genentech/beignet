...
from ..functional.statistics import welch_t_test_power


class WelchTTestPower(Metric):
    r"""
    Compute statistical power for Welch's t-test.

    This metric calculates the statistical power for Welch's t-test, which is
    the probability of correctly rejecting a false null hypothesis when comparing
    two groups with potentially unequal variances. It follows TorchMetrics
    ...
    --------
    >>> import torch
    >>> from beignet.metrics import WelchTTestPower
    >>> metric = WelchTTestPower()
    ...
    def plot(
        ...
        **kwargs: Any,
        ...
        """Plot Welch's t-test power visualization.
        ...
        **kwargs : dict
        ...
        if plot_type == "power_curve":
            ...
            if title is None:
                title = f"Welch's T-Test Power Analysis (α={self.alpha}, N1={current_n1}, N2={current_n2})"
        else:
