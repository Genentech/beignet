...
class DifferentiateLegendrePolynomialBenchmark:
    params = [
        [10, 100, 1000, 10000],
    ...
    def time_differentiate_legendre_polynomial(self, batch_size, dtype):
        self.func(self.input, self.order, self.scale, self.axis)

    def peak_memory_differentiate_legendre_polynomial(self, batch_size, dtype):
        self.func(self.input, self.order, self.scale, self.axis)
