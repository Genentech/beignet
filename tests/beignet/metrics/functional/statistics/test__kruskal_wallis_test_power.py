...
def test_kruskal_wallis_test_power(batch_size, dtype):
    """Test kruskal_wallis_test_power functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.kruskal_wallis_test_power(test_input)
        )
        result_direct = beignet.statistics.kruskal_wallis_test_power(test_input)
        ...
        assert hasattr(beignet.statistics, "kruskal_wallis_test_power")
        assert callable(beignet.metrics.functional.statistics.kruskal_wallis_test_power)
        assert callable(beignet.statistics.kruskal_wallis_test_power)
