...
def test_mcnemars_test_minimum_detectable_effect(batch_size, dtype):
    """Test mcnemars_test_minimum_detectable_effect functional wrapper."""
    ...
    try:
        result_functional = beignet.metrics.functional.statistics.mcnemars_test_minimum_detectable_effect(
            test_input,
        )
        result_direct = beignet.statistics.mcnemars_test_minimum_detectable_effect(
            test_input,
        )
        ...
        assert hasattr(beignet.statistics, "mcnemars_test_minimum_detectable_effect")
        assert callable(
            beignet.metrics.functional.statistics.mcnemars_test_minimum_detectable_effect,
        )
        assert callable(beignet.statistics.mcnemars_test_minimum_detectable_effect)
