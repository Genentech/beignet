...
def test_two_way_analysis_of_variance_power(batch_size, dtype):
    """Test two_way_analysis_of_variance_power functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.two_way_analysis_of_variance_power(
                test_input,
            )
        )
        result_direct = beignet.statistics.two_way_analysis_of_variance_power(
            test_input,
        )
        ...
        assert hasattr(beignet.statistics, "two_way_analysis_of_variance_power")
        assert callable(
            beignet.metrics.functional.statistics.two_way_analysis_of_variance_power,
        )
        assert callable(beignet.statistics.two_way_analysis_of_variance_power)
