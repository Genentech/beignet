...
def test_friedman_test_power(batch_size, dtype):
    """Test friedman_test_power functional wrapper."""
    ...
    try:
        result_functional = beignet.metrics.functional.statistics.friedman_test_power(
            test_input,
        )
        result_direct = beignet.statistics.friedman_test_power(test_input)
        ...
        assert hasattr(beignet.metrics.functional.statistics, "friedman_test_power")
        assert hasattr(beignet.statistics, "friedman_test_power")
        assert callable(beignet.metrics.functional.statistics.friedman_test_power)
        assert callable(beignet.statistics.friedman_test_power)
