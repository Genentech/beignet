...
from beignet.datasets import ATOM3DPSRDataset


class BenchATOM3DPSRDataset:
    params = [
        [10, 100, 1000],
    ]
    ...
    def peak_memory___init__(self, batch_size):
        ATOM3DPSRDataset(
            root=os.getenv("BEIGNET_BENCHMARKS_DATASET_ROOT", ".") + "/atom3d_psr",
            download=True,
            transform=None,
            target_transform=None,
        )
