...
def test_analysis_of_covariance_sample_size(batch_size, dtype):
    """Test analysis_of_covariance_sample_size functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.analysis_of_covariance_sample_size(
                test_input,
            )
        )
        result_direct = beignet.statistics.analysis_of_covariance_sample_size(
            test_input,
        )
        ...
        assert hasattr(beignet.statistics, "analysis_of_covariance_sample_size")
        assert callable(
            beignet.metrics.functional.statistics.analysis_of_covariance_sample_size,
        )
        assert callable(beignet.statistics.analysis_of_covariance_sample_size)
