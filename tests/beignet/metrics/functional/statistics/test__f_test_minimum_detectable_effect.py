...
def test_f_test_minimum_detectable_effect(batch_size, dtype):
    """Test f_test_minimum_detectable_effect functional wrapper."""
    ...
    try:
        result_functional = (
            beignet.metrics.functional.statistics.f_test_minimum_detectable_effect(
                test_input,
            )
        )
        result_direct = beignet.statistics.f_test_minimum_detectable_effect(test_input)
        ...
        assert hasattr(beignet.statistics, "f_test_minimum_detectable_effect")
        assert callable(
            beignet.metrics.functional.statistics.f_test_minimum_detectable_effect,
        )
        assert callable(beignet.statistics.f_test_minimum_detectable_effect)
