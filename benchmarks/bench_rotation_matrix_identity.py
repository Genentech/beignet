...
class RotationMatrixIdentityBenchmark:
    params = [
        [10, 100, 1000, 10000],
    ...
    def time_rotation_matrix_identity(self, batch_size, dtype):
        self.func(
            self.input,
            self.size,
            self.out,
    ...
    def peak_memory_rotation_matrix_identity(self, batch_size, dtype):
        self.func(
            self.input,
            self.size,
            self.out,
