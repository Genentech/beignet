...
from beignet._subtract_physicists_hermite_series import (
...
def multiply_physicists_hermite_series(c1, c2):
    ...
    if len(c) == 1:
        ...
        for i in range(3, len(c) + 1):
            tmp = c0
            nd = nd - 1
            c0 = subtract_physicists_hermite_series(c[-i] * xs, c1 * (2 * (nd - 1)))
