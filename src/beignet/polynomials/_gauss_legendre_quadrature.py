...
from beignet.polynomials._differentiate_legendre_polynomial import (
    differentiate_legendre_polynomial,
)
from beignet.polynomials._evaluate_legendre_polynomial import (
    evaluate_legendre_polynomial,
)
from beignet.polynomials._legendre_polynomial_companion import (
