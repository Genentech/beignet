...
def test_cliffs_delta(batch_size, dtype):
    """Test cliffs_delta functional wrapper."""
    ...
    try:
        ...
        result_direct = beignet.statistics.cliffs_delta(test_input)
        ...
        assert hasattr(beignet.metrics.functional.statistics, "cliffs_delta")
        assert hasattr(beignet.statistics, "cliffs_delta")
        assert callable(beignet.metrics.functional.statistics.cliffs_delta)
        assert callable(beignet.statistics.cliffs_delta)
