...
def test_multivariate_analysis_of_variance_power(batch_size, dtype):
    """Test multivariate_analysis_of_variance_power functional wrapper."""
    ...
    try:
        result_functional = beignet.metrics.functional.statistics.multivariate_analysis_of_variance_power(
            test_input,
        )
        result_direct = beignet.statistics.multivariate_analysis_of_variance_power(
            test_input,
        )
        ...
        assert hasattr(beignet.statistics, "multivariate_analysis_of_variance_power")
        assert callable(
            beignet.metrics.functional.statistics.multivariate_analysis_of_variance_power,
        )
        assert callable(beignet.statistics.multivariate_analysis_of_variance_power)
