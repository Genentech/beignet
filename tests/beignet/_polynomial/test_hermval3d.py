...
def test_hermval3d():
    ...
    numpy.testing.assert_raises(
        ValueError, beignet.polynomial._hermval3d.hermval3d, x1, x2, x3[:2], c3d
    )

    tgt = y1 * y2 * y3
    res = beignet.polynomial._hermval3d.hermval3d(x1, x2, x3, c3d)
    numpy.testing.assert_almost_equal(res, tgt)

    z = numpy.ones((2, 3))
    res = beignet.polynomial._hermval3d.hermval3d(z, z, z, c3d)
