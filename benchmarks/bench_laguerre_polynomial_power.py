...
class LaguerrePolynomialPowerBenchmark:
    params = [
        [10, 100, 1000, 10000],
    ...
    def time_laguerre_polynomial_power(self, batch_size, dtype):
        self.func(self.input, self.exponent, self.maximum_exponent)

    def peak_memory_laguerre_polynomial_power(self, batch_size, dtype):
        self.func(self.input, self.exponent, self.maximum_exponent)
