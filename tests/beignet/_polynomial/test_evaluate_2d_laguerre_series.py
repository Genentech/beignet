...
def test_evaluate_2d_laguerre_series():
    ...
    tgt = y1 * y2
    res = beignet.polynomial._lagval2d.evaluate_2d_laguerre_series(x1, x2, c2d)
    numpy.testing.assert_almost_equal(res, tgt)

    z = numpy.ones((2, 3))
    res = beignet.polynomial._lagval2d.evaluate_2d_laguerre_series(z, z, c2d)
