...
def test_cohens_kappa_power(batch_size, dtype):
    """Test cohens_kappa_power functional wrapper."""
    ...
    try:
        result_functional = beignet.metrics.functional.statistics.cohens_kappa_power(
            test_input,
        )
        result_direct = beignet.statistics.cohens_kappa_power(test_input)
        ...
        assert hasattr(beignet.metrics.functional.statistics, "cohens_kappa_power")
        assert hasattr(beignet.statistics, "cohens_kappa_power")
        assert callable(beignet.metrics.functional.statistics.cohens_kappa_power)
        assert callable(beignet.statistics.cohens_kappa_power)
