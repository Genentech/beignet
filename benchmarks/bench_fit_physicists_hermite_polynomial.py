...
class FitPhysicistsHermitePolynomialBenchmark:
    params = [
        [10, 100, 1000, 10000],
    ...
    def time_fit_physicists_hermite_polynomial(self, batch_size, dtype):
        self.func(
            self.input,
            self.other,
            self.degree,
    ...
    def peak_memory_fit_physicists_hermite_polynomial(self, batch_size, dtype):
        self.func(
            self.input,
            self.other,
            self.degree,
